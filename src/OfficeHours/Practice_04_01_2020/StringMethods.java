...
public class StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println("============================================");
          ...
          // length the total number of chars, int
        ...
        // toLowerCase() & toUpperCase(): change the case of the strings to upper and lower cases

        String str5 = "CYBERTEK SCHOOL";
        str5 = str5.toLowerCase();
        System.out.println(str5);  // "cybertek school"
        ...
        // substring(beginning index, ending index): create substring starting from beginning index till ending index

        String sentence1 = "I like Java";
        //                  012345678910
        // last index number = length-1
        String word1 = sentence1.substring(7, sentence1.length()); // "Java"
        String word2 = sentence1.substring(2,5+1);  // like
        String word3 = sentence1.substring(2,6)+sentence1.substring(7,11);
        System.out.println(word1);
        System.out.println(word2);
        System.out.println(word3);

        // substring (beginning index): creates the substring from biggining index till the end of the string. returns new string
        ...
        // replaceFirst(old str, new str): replace the first matching one, returnes new string
