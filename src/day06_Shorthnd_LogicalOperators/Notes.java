...
public class Notes {
    /*
    T2opics: Shorthand operators
		logical operators (!, &&, ||)
		single if statement

yesterday: primitive casting, unary operators
	...
	&&: and logic
		...
		false && false ==> false
		 ...
		 true && true   ==> true
		  ...
		  THE ONLY TIME AND LOGIC RETURNS TRUE IS WHEN BOTH CONDITION ARE TRUE, OTHERWISE ==> FALSE
...
class name: SingleIfStatement


new topics we have learned so far: +=, -=, /=, *=, %=, ||, &&


single if statement: conditions
