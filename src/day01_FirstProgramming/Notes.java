...
packagae name: day01_FirstProgramming

src folder: a folder trhat conatins packages in an organized manner
...
main method: runs the codes as java application
		...
		; means a statement is ended
		for every single statement we HAVE TO give ; to end it


IdeaProject folder: contaisn all the project that we have created in IntelliJ
